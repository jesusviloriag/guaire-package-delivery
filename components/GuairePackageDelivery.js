...
const appName = "GuairePackageDelivery"

const tokenPrefix = '&csrf=';

const pagePrefix = '&page=';

class GuairePackageDelivery {
    ...
    static init(props) {
        if(!this.instance) {
            this.instance = new GuairePackageDeliveryService();
    ...
    static login(username, password) {
        ...
        return fetch(backendUrl + "authenticate", {
            ...
            .then((responseJson) => {
                ...
                _this.instance =  new GuairePackageDeliveryService();
                ...
                return fetch(backendUrl + 'account',{
                    ...
                    .then((responseJson) => {
                        ...
                        if((responseJson)&&(responseJson.login)){
                            ...
                            AsyncStorage.setItem('@userstore:token',GuairePackageDelivery.instance.token);
                            GuairePackageDelivery.instance.user = responseJson;
                            GuairePackageDelivery.instance.userEdited = true;
...
class GuairePackageDeliveryService {
...
export default GuairePackageDelivery;